...
export function GuildDashboard() {
  ...
  return (
    <div className="guild-app">
      <TopBar
        budgetGranted={Boolean(app.permission) || app.mode === "demo"}
        mode={app.mode}
      />
      ...
      <div className="guild-grid">
        ...
        <div className="guild-stack">
          ...
          <p className="guild-hint">
            <strong className="guild-text">Post job &amp; hire</strong> runs the
            reputation loop (demo sim + live hire when registered). Run again to
            see Sable overtake Vega after feedback.
          </p>
        </div>
      </div>
